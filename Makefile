...
.PHONY: help env up down build logs ps migrate fixtures seed shell \
        test test-backend test-web e2e lint typecheck check demo-phase-0 demo-phase-1 demo-phase-2 demo-phase-3 demo-phase-4 demo-phase-5 web-install
...
demo-phase-2: ## Walk through the Phase 2 deliverable (needs `make up seed`)
	./scripts/demo-phase-2.sh

demo-phase-3: ## Walk through the Phase 3 deliverable (needs `make up seed`)
	./scripts/demo-phase-3.sh

demo-phase-4: ## Walk through the Phase 4 deliverable (needs `make up seed`)
	./scripts/demo-phase-4.sh

demo-phase-5: ## Walk through the Phase 5 deliverable (needs `make up seed`)
